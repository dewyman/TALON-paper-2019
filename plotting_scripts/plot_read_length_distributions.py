# For each listed dataset, plot the read length distribution
...
def getOptions():
    ...
    parser.add_option("--reads", dest = "infile",
        help = "TALON read_annot file", metavar = "FILE", type = "string")
    ...
    parser.add_option("--map", dest = "name_mapping",
        help = "Optional: a csv file mapping dataset IDs to other descriptors", metavar = "FILE", type = "string")
