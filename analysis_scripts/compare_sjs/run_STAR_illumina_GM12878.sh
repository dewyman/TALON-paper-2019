...
reads="${DPATH}GM12878/GM12878_rep1_illumina_1.fastq.gz,${DPATH}GM12878/GM12878_rep2_illumina_1.fastq.gz ${DPATH}GM12878/GM12878_rep1_illumina_2.fastq.gz,${DPATH}GM12878/GM12878_rep2_illumina_2.fastq.gz"
...
STAR \
	...
	--outFileNamePrefix GM12878_aligned \
